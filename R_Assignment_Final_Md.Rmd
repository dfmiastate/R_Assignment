...
T_fang_data_trim <- T_fang_data[,c(4:ncol(T_fang_data))]
M_fang_data_trim <- M_fang_data[,c(4:ncol(T_fang_data))]
...
#remove last header
TTT_fang_data <- TTT_fang_data
TTM_fang_data <- TTM_fang_data
View(TTM_fang_data)
...
r_maize_chr1_data <- r_maize_chr1_data[r_maize_chr1_data == "?/?"] <- "-/-" 
